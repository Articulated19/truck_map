...
class ObstacleHandler:
    ...
    def handleObstacles(self):
        xlim = self.map_img.size[0] * SCALE
        ylim = self.map_img.size[1] * SCALE
        ...
        plt.imshow(self.map_img.resize((self.map_img.size[0]*SCALE, self.map_img.size[1]*SCALE), Image.ANTIALIAS))
